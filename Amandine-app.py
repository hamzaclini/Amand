...
Comp = [
    "Gestion du temps libre (ex. profite des week-ends sans crainte du vide)",
    "Priorisation des tâches (ex. finit le ménage avant de passer à autre chose)",
    "Tient un objectif sans se décourager (ex. reste positive après avoir reporté des tâches)",
    "Contrôle des achats compulsifs (ex. ne se réfugie pas dans l'achat compulsif pour se sentir utile)",
    "Ponctualité et bonne humeur le matin (ex. ne repousse pas le réveil jusqu'à la dernière minute)",
    "Se prépare le matin sans agitation (ex. reste détendue pendant la préparation)",
    "Estime de soi et comparaison aux autres (ex. ne se dévalorise pas par rapport aux autres)",
    "Prise de décisions sans avoir besoin de réassurance (ex. assume ses choix sans demander de compliments)",
    "Engagement dans de nouvelles activités (ex. prend des initiatives pour s'améliorer)"
]
...
st.write("""
# Thermomètre comportemental Amandine
""")
...
slider_strings = ["Non", "Plutôt non", "Plutôt oui", "Oui"]
